...
const hoverValidId = document.getElementsByClassName('hover-valid-id');
const validId = document.getElementsByClassName('valid-id');
...
for (let i = 0; i < rows.length; i++) {
	...
	hoverValidId[i].addEventListener('mouseenter',function(){
		validId[i].style.transform = 'scale(1)';
	});

	hoverValidId[i].addEventListener('mouseleave',function(){
		validId[i].style.transform = 'scale(0)';
	});
}
